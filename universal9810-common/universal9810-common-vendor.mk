...
PRODUCT_COPY_FILES += \
    ...
    vendor/samsung/universal9810-common/proprietary/etc/apns-conf.xml:system/etc/apns-conf.xml \
    vendor/samsung/universal9810-common/proprietary/etc/gps_debug.conf:system/etc/gps_debug.conf \
    vendor/samsung/universal9810-common/proprietary/etc/media_codecs_ac4.xml:system/etc/media_codecs_ac4.xml \
    vendor/samsung/universal9810-common/proprietary/etc/media_codecs_ddp.xml:system/etc/media_codecs_ddp.xml \
    vendor/samsung/universal9810-common/proprietary/etc/media_codecs_sec_ape.xml:system/etc/media_codecs_sec_ape.xml \
    vendor/samsung/universal9810-common/proprietary/etc/media_codecs_sec_primary.xml:system/etc/media_codecs_sec_primary.xml \
    vendor/samsung/universal9810-common/proprietary/etc/media_codecs_sec_qcp.xml:system/etc/media_codecs_sec_qcp.xml \
    vendor/samsung/universal9810-common/proprietary/etc/media_codecs_sec_secondary.xml:system/etc/media_codecs_sec_secondary.xml \
    vendor/samsung/universal9810-common/proprietary/etc/media_codecs_sec_video_primary.xml:system/etc/media_codecs_sec_video_primary.xml \
    vendor/samsung/universal9810-common/proprietary/etc/nfc_key:system/etc/nfc_key \
    vendor/samsung/universal9810-common/proprietary/etc/nfcee_access.xml:system/etc/nfcee_access.xml \
    vendor/samsung/universal9810-common/proprietary/lib/hw/audio.playback_record.default.so:system/lib/hw/audio.playback_record.default.so \
    vendor/samsung/universal9810-common/proprietary/lib/hw/audio.tms.default.so:system/lib/hw/audio.tms.default.so \
    vendor/samsung/universal9810-common/proprietary/lib/libsecaudiocoreutils.so:system/lib/libsecaudiocoreutils.so \
    vendor/samsung/universal9810-common/proprietary/lib/libsecnativefeature.so:system/lib/libsecnativefeature.so \
    vendor/samsung/universal9810-common/proprietary/lib/libsecril-client.so:system/lib/libsecril-client.so \
    vendor/samsung/universal9810-common/proprietary/lib/libskeymaster.so:system/lib/libskeymaster.so \
    vendor/samsung/universal9810-common/proprietary/lib/libtinyalsa.so:system/lib/libtinyalsa.so \
    vendor/samsung/universal9810-common/proprietary/lib/vendor.samsung.hardware.gnss@1.0.so:system/lib/vendor.samsung.hardware.gnss@1.0.so \
    vendor/samsung/universal9810-common/proprietary/lib64/libaptX_encoder.so:system/lib64/libaptX_encoder.so \
    vendor/samsung/universal9810-common/proprietary/lib64/libkeymaster_helper.so:system/lib64/libkeymaster_helper.so \
    vendor/samsung/universal9810-common/proprietary/lib64/libmaet.so:system/lib64/libmaet.so \
    vendor/samsung/universal9810-common/proprietary/lib64/libsecnativefeature.so:system/lib64/libsecnativefeature.so \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/bin/bcc:$(TARGET_COPY_OUT_VENDOR)/bin/bcc \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/bin/hw/android.hardware.drm@1.1-service.widevine:$(TARGET_COPY_OUT_VENDOR)/bin/hw/android.hardware.drm@1.1-service.widevine \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/bin/hw/mfgloader:$(TARGET_COPY_OUT_VENDOR)/bin/hw/mfgloader \
    vendor/samsung/universal9810-common/proprietary/vendor/bin/hw/rild:$(TARGET_COPY_OUT_VENDOR)/bin/hw/rild \
    vendor/samsung/universal9810-common/proprietary/vendor/bin/hw/sec.android.hardware.nfc@1.1-service:$(TARGET_COPY_OUT_VENDOR)/bin/hw/sec.android.hardware.nfc@1.1-service \
    vendor/samsung/universal9810-common/proprietary/vendor/bin/hw/vendor.samsung.hardware.gnss@1.0-service:$(TARGET_COPY_OUT_VENDOR)/bin/hw/vendor.samsung.hardware.gnss@1.0-service \
    vendor/samsung/universal9810-common/proprietary/vendor/bin/hw/vendor.samsung.hardware.radio.configsvc@1.0-service:$(TARGET_COPY_OUT_VENDOR)/bin/hw/vendor.samsung.hardware.radio.configsvc@1.0-service \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/etc/init/android.hardware.bluetooth@1.0-service.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/android.hardware.bluetooth@1.0-service.rc \
    vendor/samsung/universal9810-common/proprietary/vendor/etc/init/android.hardware.drm@1.1-service.widevine.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/android.hardware.drm@1.1-service.widevine.rc \
    vendor/samsung/universal9810-common/proprietary/vendor/etc/init/android.hardware.gatekeeper@1.0-service.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/android.hardware.gatekeeper@1.0-service.rc \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/etc/init/init.vendor.rilcommon.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.vendor.rilcommon.rc \
    vendor/samsung/universal9810-common/proprietary/vendor/etc/init/sec.android.hardware.nfc@1.1-service.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/sec.android.hardware.nfc@1.1-service.rc \
    vendor/samsung/universal9810-common/proprietary/vendor/etc/init/vendor.samsung.hardware.gnss@1.0-service.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/vendor.samsung.hardware.gnss@1.0-service.rc \
    vendor/samsung/universal9810-common/proprietary/vendor/etc/init/vendor.samsung.hardware.radio.configsvc@1.0-service.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/vendor.samsung.hardware.radio.configsvc@1.0-service.rc \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/etc/libnfc-nci.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-nci.conf \
    vendor/samsung/universal9810-common/proprietary/vendor/etc/libnfc-sec-vendor.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-sec-vendor.conf \
    vendor/samsung/universal9810-common/proprietary/vendor/etc/media_codecs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs.xml \
    vendor/samsung/universal9810-common/proprietary/vendor/etc/media_codecs_google_audio.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_google_audio.xml \
    vendor/samsung/universal9810-common/proprietary/vendor/etc/media_codecs_google_telephony.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_google_telephony.xml \
    vendor/samsung/universal9810-common/proprietary/vendor/etc/media_codecs_google_video.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_google_video.xml \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/etc/nfc/sec_s3nrn82_rfreg.bin:$(TARGET_COPY_OUT_VENDOR)/etc/nfc/sec_s3nrn82_rfreg.bin \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib/hw/audio.primary.universal9810.so:$(TARGET_COPY_OUT_VENDOR)/lib/hw/audio.primary.universal9810.so \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib/hw/gralloc.exynos5.so:$(TARGET_COPY_OUT_VENDOR)/lib/hw/gralloc.exynos5.so \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib/hw/memtrack.universal9810.so:$(TARGET_COPY_OUT_VENDOR)/lib/hw/memtrack.universal9810.so \
    vendor/samsung/universal9810-common/proprietary/vendor/lib/hw/sound_trigger.primary.universal9810.so:$(TARGET_COPY_OUT_VENDOR)/lib/hw/sound_trigger.primary.universal9810.so \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib/libmpp.so:$(TARGET_COPY_OUT_VENDOR)/lib/libmpp.so \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib/libsensorndkbridge.so:$(TARGET_COPY_OUT_VENDOR)/lib/libsensorndkbridge.so \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib/vendor.samsung.hardware.radio.channel@1.0.so:$(TARGET_COPY_OUT_VENDOR)/lib/vendor.samsung.hardware.radio.channel@1.0.so \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/hw/gralloc.exynos5.so:$(TARGET_COPY_OUT_VENDOR)/lib64/hw/gralloc.exynos5.so \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/hw/memtrack.universal9810.so:$(TARGET_COPY_OUT_VENDOR)/lib64/hw/memtrack.universal9810.so \
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/hw/vendor.samsung.hardware.gnss@1.0-impl.so:$(TARGET_COPY_OUT_VENDOR)/lib64/hw/vendor.samsung.hardware.gnss@1.0-impl.so \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/libLLVM_android.so:$(TARGET_COPY_OUT_VENDOR)/lib64/libLLVM_android.so \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/libbcc.so:$(TARGET_COPY_OUT_VENDOR)/lib64/libbcc.so \
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/libbccArm.so:$(TARGET_COPY_OUT_VENDOR)/lib64/libbccArm.so \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/libclcore.bc:$(TARGET_COPY_OUT_VENDOR)/lib64/libclcore.bc \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/librilutils.so:$(TARGET_COPY_OUT_VENDOR)/lib64/librilutils.so \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/libsensorndkbridge.so:$(TARGET_COPY_OUT_VENDOR)/lib64/libsensorndkbridge.so \
    ...
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/vendor.samsung.hardware.bluetooth@1.0.so:$(TARGET_COPY_OUT_VENDOR)/lib64/vendor.samsung.hardware.bluetooth@1.0.so \
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/vendor.samsung.hardware.gnss@1.0.so:$(TARGET_COPY_OUT_VENDOR)/lib64/vendor.samsung.hardware.gnss@1.0.so \
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/vendor.samsung.hardware.nfc@1.1.so:$(TARGET_COPY_OUT_VENDOR)/lib64/vendor.samsung.hardware.nfc@1.1.so \
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/vendor.samsung.hardware.radio.channel@1.0.so:$(TARGET_COPY_OUT_VENDOR)/lib64/vendor.samsung.hardware.radio.channel@1.0.so \
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/vendor.samsung.hardware.radio.configsvc@1.0.so:$(TARGET_COPY_OUT_VENDOR)/lib64/vendor.samsung.hardware.radio.configsvc@1.0.so \
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/vendor.samsung.hardware.radio.secbridge@1.0.so:$(TARGET_COPY_OUT_VENDOR)/lib64/vendor.samsung.hardware.radio.secbridge@1.0.so \
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/vendor.samsung.hardware.radio.sechook@1.0.so:$(TARGET_COPY_OUT_VENDOR)/lib64/vendor.samsung.hardware.radio.sechook@1.0.so \
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/vendor.samsung.hardware.radio@1.2.so:$(TARGET_COPY_OUT_VENDOR)/lib64/vendor.samsung.hardware.radio@1.2.so \
    vendor/samsung/universal9810-common/proprietary/vendor/lib64/vendor.samsung.hardware.wifi@1.0.so:$(TARGET_COPY_OUT_VENDOR)/lib64/vendor.samsung.hardware.wifi@1.0.so \
